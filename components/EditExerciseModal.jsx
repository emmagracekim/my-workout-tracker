...
import { AssignmentTurnedIn, DeleteOutline } from "@material-ui/icons"
...
const EditExerciseModal = ({
  ...
  const filteredSet = selectedExerSets.filter((set) => set.id !== selected.id)
      ...
      <Modal isOpen={isEditExerciseModal} onClose={updateExercise}>
        ...
        <div className="flex justify-between">
          ...
          <div onClick={updateExercise} aria-label="correct">
            <AssignmentTurnedIn aria-label="correct" />
          </div>
        </div>
      </Modal>
    )
